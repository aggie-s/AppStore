...
class Helper(object):
    ...
    def calculate_top_5(app, user_download_history):
        ...
        for apps in user_user_download_history([app], apps):
            similarity = Helper.cosine_similarity([app], apps)
            for other_app in apps:
                if app_similarity.has_key(other_app):
                    app_similarity[other_app] = app_similarity[
    ...
    top_5_app = [sorted_tups[0][0], sorted_tups[1][0],
                 sorted_tups[2][0], sorted_tups[3][0], sorted_tups[4][0]]
    print("top_5_app for " + str(app) + ":\t" + str(top_5_app_list1))
    ...
    def main():
        try:
            ...
            calculate_top_5('C10107104', user_download_history.value())
